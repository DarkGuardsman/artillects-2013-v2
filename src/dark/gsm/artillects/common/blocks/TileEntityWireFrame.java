...
import dark.gsm.artillects.common.ai.combat.NetworkOrbit;
...
public class TileEntityWireFrame extends TileEntityAdvanced implements IAttacker, IBotController
{
	...
	{
		return this.worldObj.rayTraceBlocks_do_do(new Vector3(this).toVec3(), target.toVec3(), false, false) == null;
	}
