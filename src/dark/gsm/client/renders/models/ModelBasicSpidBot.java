...
public class ModelBasicSpidBot extends ModelBase
{
  ...
  public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6)
  {
      ...
      this.LEG1la.rotateAngleZ = -var7;
      this.LEG1lb.rotateAngleZ = -var7;
      this.LEG2La.rotateAngleZ = var7;
      this.LEG2lb.rotateAngleZ = var7;
      this.LEG3la.rotateAngleZ = -var7 * 0.74F;
      this.LEG3Lb.rotateAngleZ = -var7 * 0.74F;
      
      this.LEG1ra.rotateAngleZ = var7 * 0.74F;
      this.LEG1rb.rotateAngleZ = var7 * 0.74F;
      this.LEG2ra.rotateAngleZ = -var7 * 0.74F;
      this.LEG2rb.rotateAngleZ = -var7 * 0.74F;
      this.LEG3ra.rotateAngleZ = var7 * 0.74F;
      this.LEG3rb.rotateAngleZ = var7 * 0.74F;
      */
      float var8 = -0.0F;
