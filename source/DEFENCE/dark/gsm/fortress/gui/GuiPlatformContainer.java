...
import dark.gsm.fortress.container.ContainerTurretPlatform;
    ...
    protected void actionPerformed(GuiButton button)
    {
        if (tileEntity.getTurret(false) != null)
        {
            ...
            switch (button.id)
            {
                case 0:
                {
                    this.entityPlayer.openGui(Sentries.instance, CommonProxy.GUI_PLATFORM_TERMINAL_ID, this.tileEntity.worldObj, this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord);
                    break;
                }
                case 1:
                {
                    this.entityPlayer.openGui(Sentries.instance, CommonProxy.GUI_PLATFORM_ACCESS_ID, this.tileEntity.worldObj, this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord);
                    break;
                }
                case 2:
                {
                    this.entityPlayer.openGui(Sentries.instance, CommonProxy.GUI_PLATFORM_ID, this.tileEntity.worldObj, this.tileEntity.xCoord, this.tileEntity.yCoord, this.tileEntity.zCoord);
                    break;
                }
                case 3:
                {
