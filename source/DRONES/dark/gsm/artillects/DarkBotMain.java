...
import dark.gsm.artillects.entity.ItemBotSpawner;
import dark.gsm.artillects.gen.WorldGen;
import dark.gsm.artillects.hive.Hivemind;
import dark.gsm.artillects.hive.spire.BlockSpireCore;
import dark.gsm.artillects.hive.spire.TileEntitySpireCore;
import dark.gsm.artillects.items.DispenserBehaviorMissile;
import dark.gsm.artillects.items.ItemBlockMain;
import dark.gsm.artillects.items.ItemMain;
import dark.gsm.artillects.items.ItemRocketPod;
import dark.gsm.artillects.items.ItemWorldEdit;
import dark.gsm.artillects.tiles.BlockCreep;
...
public class DarkBotMain
{
    ...
    @SidedProxy(clientSide = "dark.drone.client.ClientProxy", serverSide = "dark.drone.CommonProxy")
